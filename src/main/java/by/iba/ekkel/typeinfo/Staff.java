//: by.iba.ekkel.typeinfo/Staff.java
...
public class Staff extends ArrayList<Position> {
	...
	public void add(ArrayList<String> titles) {
		for(String title : titles) {
			add(new Position(title));
		}
	}
	public Staff(ArrayList<String> titles) {
		add(titles);
	}
	...
	public static void main(String[] args) {
		...
		Collection<String> listPositions = new ArrayList<String>();
		Collections.addAll(listPositions, "President", "CTO",
				"Marketing Manager","Product Manager",
				"Project Lead", "Software Engineer",
				"Software Engineer", "Software Engineer",
				"Software Engineer",  "Test Engineer",
				"Technical Writer");
		Staff staff = new Staff((ArrayList<String>)listPositions);
